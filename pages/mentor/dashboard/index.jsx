...
import { fetchUpcomingLiveClasses } from '@/helpers/api/mentor/courses'
...
export const ReminderCard = ({ type, title, time, students, description }) => {
  ...
  return (
    ...
    >
      ...
      <span className="text-xs lg:text-sm text-gray-500">{description}</span>
    </div>
  )
}
    ...
    <div>
      ...
      <div className="w-full h-screen">
        ...
        <div className="mt-8 ml-4 mb-4">
          ...
          <div className="w-full flex flex-row gap-4 overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 scrollbar-track-rounded-2xl">
            <ProductCard />
            <ProductCard />
            <ProductCard />
            <ProductCard />
